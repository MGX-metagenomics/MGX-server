...
public class AttributeDAO<T extends Attribute> extends DAO<T> {
    ...
    public Map<Attribute, Long> getDistribution(AttributeType attrType, Job job) throws MGXException {
    ...
    public Map<Attribute, Long> getHierarchy(Long attrTypeId, Job job) throws MGXException {
        ...
        Map<Attribute, Long> ret = new HashMap<Attribute, Long>();
        Map<Long, AttributeType> aTypeCache = new HashMap<Long, AttributeType>();
        Map<Long, Attribute> attrCache = new HashMap<Long, Attribute>();
        Map<Long, Long> attr2parent = new HashMap<Long, Long>();
        Connection conn = getController().getConnection();
        PreparedStatement stmt = null;
        ResultSet rs = null;
